  ...
  const columns = [
    {
      title: t("explore"),
      links: [
        { label: nav("perfumes"), href: "/perfumes" },
        { label: nav("brands"), href: "/brands" },
        { label: nav("notes"), href: "/notes" },
        { label: nav("perfumers"), href: "/perfumers" },
      ],
    },
    {
      title: t("discover"),
      links: [
        { label: nav("finder"), href: "/finder" },
        { label: nav("compare"), href: "/compare" },
        { label: t("bestPerfumes"), href: "/best" },
        { label: t("newReleases"), href: "/perfumes?sort=newest" },
      ],
    },
    {
      title: nav("community"),
      links: [
        { label: t("forums"), href: "/community" },
